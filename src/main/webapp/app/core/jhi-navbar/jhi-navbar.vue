<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="bg-dark">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span class="navbar-title">easyinsurance</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/seguradora">
            <font-awesome-icon icon="asterisk" />
            <span>Seguradora</span>
          </b-dropdown-item>
          <b-dropdown-item to="/proposta">
            <font-awesome-icon icon="asterisk" />
            <span>Proposta</span>
          </b-dropdown-item>
          <b-dropdown-item to="/plano">
            <font-awesome-icon icon="asterisk" />
            <span>Plano</span>
          </b-dropdown-item>
