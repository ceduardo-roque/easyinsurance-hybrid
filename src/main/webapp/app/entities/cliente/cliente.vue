  ...
  <div>
      ...
      <div class="d-flex justify-content-end">
        ...
        <router-link :to="{ name: 'ClienteCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span> Create a new Cliente </span>
          </button>
        </router-link>
      </div>
    </h2>
      ...
      <table class="table table-striped" aria-describedby="clientes">
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('nomeCliente')">
              <span>Nome Cliente</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'nomeCliente'"></jhi-sort-indicator>
            </th>
        ...
        <tbody>
          <tr v-for="cliente in clientes" :key="cliente.id" data-cy="entityTable">
            ...
            <td>
              <a v-if="cliente.foto" v-on:click="openFile(cliente.fotoContentType, cliente.foto)">
                <img
              ...
              <span v-if="cliente.foto">{{ cliente.fotoContentType }}, {{ byteSize(cliente.foto) }}</span>
            </td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="easyinsuranceApp.cliente.delete.question" data-cy="clienteDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-cliente-heading">Are you sure you want to delete this Cliente?</p>
      </div>
