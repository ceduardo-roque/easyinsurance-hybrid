...
export default class Seguradora extends Vue {
  ...
  public retrieveAllSeguradoras(): void {
  ...
  public prepareRemove(instance: ISeguradora): void {
  ...
  public removeSeguradora(): void {
    this.seguradoraService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A Seguradora is deleted with identifier ' + this.removeId;
